...
<div class="topnav">
  <a href="http://localhost/Project/Tank.php#">Home</a>
  <a href="#">Tank Type</a>
  <a href="#">Ammo Rack</a>
  <a href="#">Parts</a>
  <a href="#">Customize</a>
  ...
  <a href="Guest_Book2.php">Guest Book</a>
  <a href="Suggestion2.php">Suggestion</a>
  <a href="http://localhost/Project/index.php#">Weapon&Megazines</a>
</div>
...
if ($result->num_rows > 0) {
	...
	echo '   
	<div class="gallery">
		<div class="name"><a target="_blank" href="Pesan2.php?id_barang='.$row['id_barang'].'">'.$row['nama_barang'].'</a></div>
		...
		<div class ="row"><a target="_blank" href="Pesan2.php?id_barang='.$row['id_barang'].'"><input type = "submit" name = "submit" value = "BUY"></div>
	</div>
