...
<div class="topnav">
  ...
  <a href="Tank.php">Armored Car&Tank</a>
</div>
...
if ($result->num_rows > 0) {
	...
	echo '   
	<div class="gallery">
		<div class="name"><a target="_blank" href="Pesan.php?id_barang='.$row['id_barang'].'">'.$row['nama_barang'].'</a></div>
		<img src="Produk/'.$row['foto_barang'].'"alt="Cinque Terre" width="800" height="500">
		<div class="desc">'.$row['deskripsi_barang'].'</div>
		<div class="diskon">'.$row['harga_diskon'].'</div>
		<div class="price">$'.$row['harga_barang'].'USD</div>
		<div class ="row"><a target="_blank" href="Pesan.php?id_barang='.$row['id_barang'].'"><input type = "submit" name = "submit" value = "BUY"></div>
	</div>
